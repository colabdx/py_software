...
class ScalePlayerApp:
    def __init__(self, root):
        ...
        # NOTE: Input field for decimal pattern
        self.input_label = ttk.Label(self.main_frame, text="Decimal Pattern:")
    ...
    def on_play_button(self):
        ...
        try:
            ...
            decimal_pattern = self.input_field.get()
            
            # Convert decimal to binary string, removing the '0b' prefix
            decimal_value = int(decimal_pattern)
            scale_binary = bin(decimal_value)[2:]
